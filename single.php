...
$sections = $mosbelocal_options['archive-page-sections']['Enabled'];
$layout = $mosbelocal_options['archive-page-layout'];
?><?php get_header() ?>
<section id="blogs" class="page-content <?php if(@$mosbelocal_options['sections-content-background-type'] == 1) echo @$mosbelocal_options['sections-content-background'];?>">
