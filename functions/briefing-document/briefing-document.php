<?php
    ...
    // else:        
        ...
        $mail->Body = $dumketo['belocal_marketing_email_body_text'] ;
        $mail->Subject = $dumketo['belocal_marketing_subject'] .' '. $_POST['bname'] ;
        if ( $dumketo['belocal_marketing_recipient'] ):
            foreach ( $dumketo['belocal_marketing_recipient'] as $belocal_marketing_recipient_id => $belocal_marketing_recipient_value ) {
