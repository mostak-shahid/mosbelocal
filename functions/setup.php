<?php
//Add theme setup
if ( ! function_exists( 'mosbelocal_setup' ) ) :
	function mosbelocal_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'mosbelocal'),
			'mobilemenu' => __('Mobile Menu', 'mosbelocal'),
		));
...
add_action( 'after_setup_theme', 'mosbelocal_setup' );