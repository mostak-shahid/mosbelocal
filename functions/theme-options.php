<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'mode'     => 'css',
                'theme'    => 'monokai',
                //'desc'     => 'Possible modes can be found at <a href="' . 'http://' . 'ace.c9.io" target="_mosbelocal">' . 'http://' . 'ace.c9.io/</a>.',
                //'default'  => "body{\n   margin: 0 auto;\n}"
            ),
            array(
                'id'       => 'misc-settings-js',
    ...
    //Alt Tag
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Alt Tag', 'redux-framework-demo' ),
        'id'               => 'misc-alt',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            array(
                'id'       => 'misc-img-alt',
                'type'     => 'multi_text',
                'title'    => __( 'Image Alt Tag', 'redux-framework-demo' ),
            ),
        )
    ) );
    //Form Setup
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Form Setup', 'redux-framework-demo' ),
        'id'               => 'misc-form',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            array(
                'id'       => 'misc-form-recipient',
                'type'     => 'multi_text',
                'title'    => __( 'Digital Marketing Recipient', 'redux-framework-demo' ),
                'desc'     => 'First Add Name then email address Example: Hasan Ahmed Jobayer, jobayer@belocal.today'
            ),
            array(
                'id'       => 'misc-form-subject',
                'type'     => 'editor',
                'title'    => __( 'Digital Marketing Subject', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'misc-form-email',
                'type'     => 'editor',
                'title'    => __( 'Digital Marketing Email Text', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'misc-form-body',
                'type'     => 'editor',
                'title'    => __( 'Digital Marketing Email Body Text', 'redux-framework-demo' ),
            ),
        )
    ) );
	//MISC
    ...
    //Form Section
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Form Section', 'redux-framework-demo' ),
        'id'               => 'sections-contact',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            ...
            array(
                ...
                'placeholder' => array(
                    'title'       => __( 'This is a title', 'redux-framework-demo' ),
                    'description' => __( 'Description Here', 'redux-framework-demo' ),
                    'link_title'         => __( 'Slug', 'redux-framework-demo' ),
                    'link_url'         => __( 'Give us a link!', 'redux-framework-demo' ),
                )
            ),
            array(
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                // Leave this as a mosbelocal section, no options just some intro text set above.
                'fields' => array()
            );
