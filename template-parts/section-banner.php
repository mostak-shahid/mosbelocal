...
$select = $mosbelocal_options['sections-banner-select'];
$slides = $mosbelocal_options['sections-banner-details'];
$shortcode = $mosbelocal_options['sections-banner-shortcode'];
$n = 1;
