...
$title = $mosbelocal_options['sections-widgets-title'];
$content = $mosbelocal_options['sections-widgets-content'];
$widget_layout = $mosbelocal_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" <?php if(@$mosbelocal_options['sections-widgets-background-type'] == 1) echo 'class="'.@$mosbelocal_options['sections-widgets-background'].'"';?>>
